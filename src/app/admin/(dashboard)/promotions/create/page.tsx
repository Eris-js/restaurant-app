...
import { createPromotionAction } from '@/actions/promotion-actions';
        ...
        <div className="max-w-2xl mx-auto bg-white p-8 rounded shadow">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" required className="mt-1 block w-full border border-gray-300 rounded px-3 py-2"></textarea>
                </div>
                <div>
                    <label className="block text-sm font-medium text-gray-700">Thumbnail</label>
                    <input type="text" name="thumbnail" placeholder="URL or upload below" className="mt-1 block w-full border border-gray-300 rounded px-3 py-2 mb-2" />
                    <input type="file" name="thumbnailFile" accept="image/*" className="block w-full text-sm text-gray-500" />
                </div>
                ...
                <div className="flex justify-end">
                    <button type="submit" disabled={uploading} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 disabled:opacity-50">
                        {uploading ? 'Processing...' : 'Create Promotion'}
                    </button>
                </div>
            </form>
        </div>
